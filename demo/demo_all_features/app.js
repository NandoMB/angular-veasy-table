      ...
      veasyTableConfig: function() {
        return {
          columns: [
            ...
            { size: 10, header: 'Gender', value: 'gender', hideOn: '', dropdown: true, default: 'Not Informed' },
            { size: 10, header: 'Company', value: 'company', hideOn: 'xs', dropdown: true, default: 'Not Informed' },
