...
angular.module("veasy.table").directive("veasyTable",["$templateCache","$window","$filter","$timeout","vtScreenService","vtPaginationService","vtSearchService","vtCheckboxService","vtColumnService","vtConfigService","vtModalService",function(e,n,t,o,i,a,c,r,l,s,u){return{restrict:"E",replace:!0,templateUrl:"template.html",scope:{config:"=",list:"="},link:function(e,d,g,f){var p=function(){e.config=s.validate(e.config),e.vetModalId=u.getModalId(e.config.id),e.filterColumnsList=c.getColumnsDropdown(e.config.columns,e.config.labels),e.selectedColumn=e.filterColumnsList[0],e.condition="AND",e.searching=!1,e.master={checkbox:!1,expanded:!1},e.checkboxes=[],e.expanded=[],e.resultList=[],h(),m(e.config),x()},m=function(n){n.toggleColumns.enable&&T(e.config),n.columnFilter.enable&&n.columnFilter.modalOptions.autoOpen&&o(function(){e.openColumnFilterModal(n.columns)},0)},h=function(){e.$watch("list",function(n){n&&(e.resultList=angular.copy(n),e.filteredList=angular.copy(n),P(e.filteredList,e.config.pagination.itemsPerPage,0),v("resize"))}),e.$watch("config.columns",function(e){e&&v("resize")},!0),n.addEventListener("resize",function(){e.updatingTableColumns=!0,e.outOfBound=!1,e.$apply(function(){o(function(){i.isBrokenLayout(e.config.id)&&(e.outOfBound=!0),x(),w(),o(function(){e.updatingTableColumns=!1},500)},0)})})},v=function(e){o(function(){n.dispatchEvent(new Event(e))},0)};e.getTBodyStyle=function(){var n=angular.element("table#"+e.config.id),t=angular.element("table#"+e.config.id+" > tfoot").height(),o={};return n&&(o.width=n.width()?n.width()+"px":"0px",o.height=n.height()?n.height()-t+1+"px":"0px",n.position()&&(o.top=n.position().top?n.position().top+"px":"0px",o.left=n.position().left?n.position().left+"px":"0px")),o};var x=function(){e.toggleRowColspan=l.defineToggleRowColspan(e.config.columns),l.closeAllOpenedRows(e.resultList)};e.openColumnFilterModal=function(n){e.modalColumns=u.getColumns(n),e.modalCheckboxMaster=u.initMasterCheckbox(e.vetModalId,e.modalColumns),u.openModal(e.vetModalId,e.config.columnFilter.modalOptions)},e.checkWindowSize=function(n){var t="#"+e.vetModalId+" input#cbMaster-"+n.value;e.modalCheckboxMaster[n.value]=u.defineMasterCheckboxState(t,n)},e.checkWindowSizeMaster=function(e,n){for(var t in e.hideOn)e.hideOn[t]=n},e.checkAllByScreenSize=function(n,t,o){e.screenSize||(e.screenSize={}),e.screenSize[n]=!o,e.modalCheckboxMaster=u.checkAllByScreenSize(n,t,e.screenSize[n],e.vetModalId)},e.onConfirmColumnFilterModal=function(n){e.config.columns=u.updateColumnsVisibility(e.config.columns,n),delete e.modalColumns,u.closeModal(e.vetModalId),e.$emit("veasyTable:onApplyColumnFilter",angular.copy(e.config.columns))},e.onClickRow=function(n){var t=angular.copy(n);delete t.$$hashKey,e.$emit("veasyTable:onClickRow",t)},e.checkAllPageRows=function(n,t){e.checkboxes[n]||(e.checkboxes[n]={});for(var o=0;o<e.checkboxes[n].length;o++)e.checkboxes[n][o]=t},e.checkRow=function(n,t,o){n.stopPropagation(),e.checkboxes[t]||(e.checkboxes[t]={}),e.checkboxes[t][o]||(e.checkboxes[t][o]=!!e.checkboxes[t][o]),b(t)};var C=function(n){e.checkboxes=r.reset(n)},b=function(n){var t="#"+e.config.id+" input#checkbox-master";e.master.checkbox=r.defineCheckboxMasterState(t,e.checkboxes,n)};e.sort=function(n){if(e.$emit("veasyTable:onStartSort"),e.predicate===n&&(e.reverse=!e.reverse),e.predicate=n,""!==e.predicate){var o=t("orderBy")(e.filteredList,e.predicate,e.reverse);P(o,e.config.pagination.itemsPerPage,0)}e.$emit("veasyTable:onEndSort")},e.defineSortableIcon=function(e,n){return{"fa-sort":y("",n),"fa-sort-asc":y("asc",n),"fa-sort-desc":y("desc",n)}};var y=function(n,t){return"asc"===n?e.predicate===t&&!e.reverse:"desc"!==n||e.predicate===t&&e.reverse};e.selectFilterColumn=function(n,t,o){e.selectedColumn=o,n&&e.search(n,t,o)},e.changeSearchCondition=function(n,t,o){e.condition=t,n&&e.search(n,t,o)},e.search=function(n,t,i){t&&i&&(e.searching=!0,e.queryBusy?o.cancel(e.queryBusy):e.$emit("veasyTable:onStartSearch"),e.queryBusy=o(function(){e.filteredList=c.search(n||"",t,i,e.resultList),P(e.filteredList,e.config.pagination.itemsPerPage,0),e.searching=!1,e.$emit("veasyTable:onEndSearch")},e.config.filter.delay))},e.isUrl=function(e){return"url"===e.filter.type},e.applyFilter=function(e,n){return"currency"===n.type?t("currency")(e,n.symbol,n.fractionSize):"date"===n.type?t("date")(e,n.format,n.timezone):"json"===n.type?t("json")(e,n.spacing):"url"===n.type?t("vtUrl")(e,n.text,n.target):"number"===n.type?t("number")(e,n.fractionSize):"limitTo"===n.type?t("limitTo")(e,n.limit,n.begin):"lowercase"===n.type?t("lowercase")(e):"uppercase"===n.type?t("uppercase")(e):e},e.changeItemsPerPage=function(n){P(e.filteredList,n,0)},e.setPage=function(n){e.currentPage=n,e.pages=a.pages(e.paginatedList.length-1,n,5),e.expanded=[],e.master.expanded=!1,S(),b(e.currentPage)},e.nextPage=function(){e.currentPage<e.paginatedList.length-1&&e.setPage(e.currentPage+1)},e.previousPage=function(){e.currentPage>0&&e.setPage(e.currentPage-1)},e.isNextPageDisabled=function(n){if(n)return e.currentPage===n.length-1},e.isPreviousPageDisabled=function(){return 0===e.currentPage};var P=function(n,t,o){return e.config.pagination.enable?(e.$emit("veasyTable:onStartPagination"),e.paginatedList=a.paginate(n,t),e.setPage(o),C(e.paginatedList),void e.$emit("veasyTable:onEndPagination")):(e.paginatedList=[n],void(e.currentPage=0))},S=function(){e.hiddenContent||(e.hiddenContent=[]),e.hiddenContent[e.currentPage||0]||(e.hiddenContent[e.currentPage||0]=[])},k=function(n,t){S(),e.hiddenContent[e.currentPage][n]=l.getHiddenContent(t,e.config.columns)},w=function(){if(e.paginatedList&&e.paginatedList[e.currentPage])for(var n=0;n<e.paginatedList[e.currentPage].length;n++)k(n,e.paginatedList[e.currentPage][n])};e.initToggleButton=function(n,t){e.expanded[n]=!1,k(n,t)},e.toggleRow=function(n,t,o){n.stopPropagation(),e.expanded[t]=!e.expanded[t]},e.showToggleIcon=function(n){return e.config.toggleColumns&&e.config.toggleColumns.enable&&n.toggle&&e.haveHiddenColumn(e.config.columns)},e.toggleAllRows=function(){e.master.expanded=!e.master.expanded,e.master.expanded?L():M()};var L=function(){for(var n=0;n<e.expanded.length;n++)e.expanded[n]=!0},M=function(){for(var n=0;n<e.expanded.length;n++)e.expanded[n]=!1};e.showToggleHeader=function(n){return!n.toggle||n.toggle&&e.haveHiddenColumn(e.config.columns)},e.haveHiddenColumn=function(e){return l.haveHiddenColumn(e)},e.getToggleIconClasses=function(e,n,t){var o={};return o[e.toggleColumns.icons.closed]=t,o[e.toggleColumns.icons.opened]=n,o};var T=function(e){"begin"===e.toggleColumns.position?e.columns.unshift({header:"",value:"toggle",hideOn:"",toggle:!0}):e.columns.push({header:"",value:"toggle",hideOn:"",toggle:!0})};e.getColumnStyle=function(n){return n.toggle?{width:"37px","text-align":"center"}:e.outOfBound?{"max-width":"1px","min-width":"1px"}:{}};e.responsiveHiddenContentStyle=function(){var e=i.screenSize();return"lg"===e?{"max-width":"1060px"}:"md"===e?{"max-width":"860px"}:"sm"===e?{"max-width":"660px"}:"xs"===e?{"max-width":"260px"}:{}},e.hideColumnOn=function(e,n){return i.isNeedToHide(n)?(e.isHidden=!0,!0):(delete e.isHidden,!1)},p()}}}]);